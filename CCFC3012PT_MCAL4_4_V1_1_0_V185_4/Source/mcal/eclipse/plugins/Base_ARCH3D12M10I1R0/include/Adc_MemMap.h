...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define ADC_MEMMAP_SECTION_NOTMATCH_ERROR   "Adc_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_ADC_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ADC_STOP_SEC_CONFIG_DATA
            #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_ADC_START_SEC_CONFIG_DATA
        #undef ENTERED_ADC_START_SEC_CONFIG_DATA
    #else
        #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef ADC_START_SEC_VAR_NO_INIT
    #undef ADC_START_SEC_VAR_NO_INIT
    #define ENTERED_ADC_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ADC_STOP_SEC_VAR_NO_INIT
            #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ADC_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_ADC_START_SEC_VAR_NO_INIT
        #undef ENTERED_ADC_START_SEC_VAR_NO_INIT
    #else
        #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ADC_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ADC_START_SEC_VAR_INIT
    #undef ADC_START_SEC_VAR_INIT
    #define ENTERED_ADC_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ADC_STOP_SEC_VAR_INIT
            #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ADC_STOP_SEC_VAR_INIT
    #ifdef ENTERED_ADC_START_SEC_VAR_INIT
        #undef ENTERED_ADC_START_SEC_VAR_INIT
    #else
        #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef ADC_START_SEC_VAR_SHARED_INIT
    #undef ADC_START_SEC_VAR_SHARED_INIT
    #define ENTERED_ADC_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ADC_STOP_SEC_VAR_SHARED_INIT
            #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ADC_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_ADC_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_ADC_START_SEC_VAR_SHARED_INIT
    #else
        #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ADC_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ADC_START_SEC_VAR_SHARED_NO_INIT
    #undef ADC_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_ADC_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef ADC_STOP_SEC_VAR_SHARED_NO_INIT
            #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ADC_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_ADC_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_ADC_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error ADC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ADC_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Adc_MemMap.h, no valid memory mapping symbol defined."
#endif

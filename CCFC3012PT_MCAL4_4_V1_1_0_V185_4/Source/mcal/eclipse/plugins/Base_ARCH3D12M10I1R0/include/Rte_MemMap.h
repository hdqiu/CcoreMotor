...
* @file Rte_MemMap.h
* @version 1.0.1
**@brief   AUTOSAR RTE Rte - module interface.
...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define RTE_MEMMAP_SECTION_NOTMATCH_ERROR   "Rte_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef RTE_START_SEC_CONFIG_DATA
    #undef RTE_START_SEC_CONFIG_DATA
    #define ENTERED_RTE_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef RTE_STOP_SEC_CONFIG_DATA
            #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef RTE_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_RTE_START_SEC_CONFIG_DATA
        #undef ENTERED_RTE_START_SEC_CONFIG_DATA
    #else
        #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef RTE_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef RTE_START_SEC_VAR_NO_INIT
    #undef RTE_START_SEC_VAR_NO_INIT
    #define ENTERED_RTE_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef RTE_STOP_SEC_VAR_NO_INIT
            #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef RTE_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_RTE_START_SEC_VAR_NO_INIT
        #undef ENTERED_RTE_START_SEC_VAR_NO_INIT
    #else
        #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef RTE_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef RTE_START_SEC_VAR_INIT
    #undef RTE_START_SEC_VAR_INIT
    #define ENTERED_RTE_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef RTE_STOP_SEC_VAR_INIT
            #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef RTE_STOP_SEC_VAR_INIT
    #ifdef ENTERED_RTE_START_SEC_VAR_INIT
        #undef ENTERED_RTE_START_SEC_VAR_INIT
    #else
        #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef RTE_START_SEC_VAR_SHARED_INIT
    #undef RTE_START_SEC_VAR_SHARED_INIT
    #define ENTERED_RTE_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef RTE_STOP_SEC_VAR_SHARED_INIT
            #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef RTE_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_RTE_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_RTE_START_SEC_VAR_SHARED_INIT
    #else
        #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef RTE_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef RTE_START_SEC_VAR_SHARED_NO_INIT
    #undef RTE_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_RTE_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef RTE_STOP_SEC_VAR_SHARED_NO_INIT
            #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef RTE_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_RTE_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_RTE_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error RTE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef RTE_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif

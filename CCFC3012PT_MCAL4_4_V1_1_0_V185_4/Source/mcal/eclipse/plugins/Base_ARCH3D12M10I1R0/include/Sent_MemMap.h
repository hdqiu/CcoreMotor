...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define SENT_MEMMAP_SECTION_NOTMATCH_ERROR   "Sent_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef SENT_START_SEC_CONFIG_DATA
    #undef SENT_START_SEC_CONFIG_DATA
    #define ENTERED_SENT_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SENT_STOP_SEC_CONFIG_DATA
            #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SENT_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_SENT_START_SEC_CONFIG_DATA
        #undef ENTERED_SENT_START_SEC_CONFIG_DATA
    #else
        #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef SENT_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef SENT_START_SEC_VAR_NO_INIT
    #undef SENT_START_SEC_VAR_NO_INIT
    #define ENTERED_SENT_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SENT_STOP_SEC_VAR_NO_INIT
            #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SENT_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_SENT_START_SEC_VAR_NO_INIT
        #undef ENTERED_SENT_START_SEC_VAR_NO_INIT
    #else
        #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef SENT_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef SENT_START_SEC_VAR_INIT
    #undef SENT_START_SEC_VAR_INIT
    #define ENTERED_SENT_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SENT_STOP_SEC_VAR_INIT
            #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SENT_STOP_SEC_VAR_INIT
    #ifdef ENTERED_SENT_START_SEC_VAR_INIT
        #undef ENTERED_SENT_START_SEC_VAR_INIT
    #else
        #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef SENT_START_SEC_VAR_SHARED_INIT
    #undef SENT_START_SEC_VAR_SHARED_INIT
    #define ENTERED_SENT_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SENT_STOP_SEC_VAR_SHARED_INIT
            #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SENT_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_SENT_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_SENT_START_SEC_VAR_SHARED_INIT
    #else
        #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef SENT_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef SENT_START_SEC_VAR_SHARED_NO_INIT
    #undef SENT_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_SENT_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef SENT_STOP_SEC_VAR_SHARED_NO_INIT
            #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SENT_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_SENT_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_SENT_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error SENT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef SENT_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Sent_MemMap.h, no valid memory mapping symbol defined."
#endif

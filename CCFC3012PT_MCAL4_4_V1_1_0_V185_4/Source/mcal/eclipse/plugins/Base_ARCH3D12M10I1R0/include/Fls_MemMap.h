...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define FLS_MEMMAP_SECTION_NOTMATCH_ERROR   "Fls_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_FLS_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FLS_STOP_SEC_CONFIG_DATA
            #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_FLS_START_SEC_CONFIG_DATA
        #undef ENTERED_FLS_START_SEC_CONFIG_DATA
    #else
        #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef FLS_START_SEC_VAR_NO_INIT
    #undef FLS_START_SEC_VAR_NO_INIT
    #define ENTERED_FLS_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FLS_STOP_SEC_VAR_NO_INIT
            #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FLS_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_FLS_START_SEC_VAR_NO_INIT
        #undef ENTERED_FLS_START_SEC_VAR_NO_INIT
    #else
        #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FLS_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef FLS_START_SEC_VAR_INIT
    #undef FLS_START_SEC_VAR_INIT
    #define ENTERED_FLS_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FLS_STOP_SEC_VAR_INIT
            #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FLS_STOP_SEC_VAR_INIT
    #ifdef ENTERED_FLS_START_SEC_VAR_INIT
        #undef ENTERED_FLS_START_SEC_VAR_INIT
    #else
        #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef FLS_START_SEC_VAR_SHARED_INIT
    #undef FLS_START_SEC_VAR_SHARED_INIT
    #define ENTERED_FLS_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FLS_STOP_SEC_VAR_SHARED_INIT
            #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FLS_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_FLS_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_FLS_START_SEC_VAR_SHARED_INIT
    #else
        #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FLS_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef FLS_START_SEC_VAR_SHARED_NO_INIT
    #undef FLS_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_FLS_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef FLS_STOP_SEC_VAR_SHARED_NO_INIT
            #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FLS_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_FLS_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_FLS_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error FLS_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FLS_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif

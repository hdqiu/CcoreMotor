...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define EDMA_MEMMAP_SECTION_NOTMATCH_ERROR   "Edma_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef EDMA_START_SEC_CONFIG_DATA
    #undef EDMA_START_SEC_CONFIG_DATA
    #define ENTERED_EDMA_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef EDMA_STOP_SEC_CONFIG_DATA
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_EDMA_START_SEC_CONFIG_DATA
        #undef ENTERED_EDMA_START_SEC_CONFIG_DATA
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef EDMA_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef EDMA_START_SEC_CODE
    #undef EDMA_START_SEC_CODE
    #define ENTERED_EDMA_START_SEC_CODE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef EDMA_STOP_SEC_CODE
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_CODE
    #ifdef ENTERED_EDMA_START_SEC_CODE
        #undef ENTERED_EDMA_START_SEC_CODE
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef EDMA_START_SEC_VAR_NO_INIT
    #undef EDMA_START_SEC_VAR_NO_INIT
    #define ENTERED_EDMA_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef EDMA_STOP_SEC_VAR_NO_INIT
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_EDMA_START_SEC_VAR_NO_INIT
        #undef ENTERED_EDMA_START_SEC_VAR_NO_INIT
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef EDMA_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef EDMA_START_SEC_VAR_INIT
    #undef EDMA_START_SEC_VAR_INIT
    #define ENTERED_EDMA_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef EDMA_STOP_SEC_VAR_INIT
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_VAR_INIT
    #ifdef ENTERED_EDMA_START_SEC_VAR_INIT
        #undef ENTERED_EDMA_START_SEC_VAR_INIT
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef EDMA_START_SEC_VAR_SHARED_INIT
    #undef EDMA_START_SEC_VAR_SHARED_INIT
    #define ENTERED_EDMA_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef EDMA_STOP_SEC_VAR_SHARED_INIT
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_EDMA_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_EDMA_START_SEC_VAR_SHARED_INIT
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef EDMA_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef EDMA_START_SEC_VAR_SHARED_NO_INIT
    #undef EDMA_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_EDMA_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef EDMA_STOP_SEC_VAR_SHARED_NO_INIT
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_EDMA_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_EDMA_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef EDMA_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef EDMA_START_SEC_RAMCODE
    #undef EDMA_START_SEC_RAMCODE
    #define ENTERED_EDMA_START_SEC_RAMCODE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef EDMA_STOP_SEC_RAMCODE
            #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef EDMA_STOP_SEC_RAMCODE
    #ifdef ENTERED_EDMA_START_SEC_RAMCODE
        #undef ENTERED_EDMA_START_SEC_RAMCODE
    #else
        #error EDMA_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
#ifdef MEM_ERROR
    #error "Edma_MemMap.h, no valid memory mapping symbol defined."
#endif

...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define MSC_MEMMAP_SECTION_NOTMATCH_ERROR   "Msc_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef MSC_START_SEC_CONFIG_DATA
    #undef MSC_START_SEC_CONFIG_DATA
    #define ENTERED_MSC_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef MSC_STOP_SEC_CONFIG_DATA
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_MSC_START_SEC_CONFIG_DATA
        #undef ENTERED_MSC_START_SEC_CONFIG_DATA
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef MSC_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef MSC_START_SEC_CODE
    #undef MSC_START_SEC_CODE
    #define ENTERED_MSC_START_SEC_CODE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef MSC_STOP_SEC_CODE
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_CODE
    #ifdef ENTERED_MSC_START_SEC_CODE
        #undef ENTERED_MSC_START_SEC_CODE
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef MSC_START_SEC_VAR_NO_INIT
    #undef MSC_START_SEC_VAR_NO_INIT
    #define ENTERED_MSC_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef MSC_STOP_SEC_VAR_NO_INIT
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_MSC_START_SEC_VAR_NO_INIT
        #undef ENTERED_MSC_START_SEC_VAR_NO_INIT
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef MSC_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef MSC_START_SEC_VAR_INIT
    #undef MSC_START_SEC_VAR_INIT
    #define ENTERED_MSC_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef MSC_STOP_SEC_VAR_INIT
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_VAR_INIT
    #ifdef ENTERED_MSC_START_SEC_VAR_INIT
        #undef ENTERED_MSC_START_SEC_VAR_INIT
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef MSC_START_SEC_VAR_SHARED_INIT
    #undef MSC_START_SEC_VAR_SHARED_INIT
    #define ENTERED_MSC_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef MSC_STOP_SEC_VAR_SHARED_INIT
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_MSC_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_MSC_START_SEC_VAR_SHARED_INIT
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef MSC_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef MSC_START_SEC_VAR_SHARED_NO_INIT
    #undef MSC_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_MSC_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef MSC_STOP_SEC_VAR_SHARED_NO_INIT
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_MSC_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_MSC_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef MSC_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef MSC_START_SEC_RAMCODE
    #undef MSC_START_SEC_RAMCODE
    #define ENTERED_MSC_START_SEC_RAMCODE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef MSC_STOP_SEC_RAMCODE
            #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef MSC_STOP_SEC_RAMCODE
    #ifdef ENTERED_MSC_START_SEC_RAMCODE
        #undef ENTERED_MSC_START_SEC_RAMCODE
    #else
        #error MSC_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
#ifdef MEM_ERROR
    #error "Msc_MemMap.h, no valid memory mapping symbol defined."
#endif

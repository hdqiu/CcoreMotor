...
* @file Etpu_MemMap.h
* @version 1.0.1
**@brief   AUTOSAR ETPU Rte - module interface.
...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define ETPU_MEMMAP_SECTION_NOTMATCH_ERROR   "Etpu_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef ETPU_START_SEC_CONFIG_DATA
    #undef ETPU_START_SEC_CONFIG_DATA
    #define ENTERED_ETPU_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ETPU_STOP_SEC_CONFIG_DATA
            #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ETPU_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_ETPU_START_SEC_CONFIG_DATA
        #undef ENTERED_ETPU_START_SEC_CONFIG_DATA
    #else
        #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef ETPU_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ETPU_START_SEC_VAR_NO_INIT
    #undef ETPU_START_SEC_VAR_NO_INIT
    #define ENTERED_ETPU_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ETPU_STOP_SEC_VAR_NO_INIT
            #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ETPU_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_ETPU_START_SEC_VAR_NO_INIT
        #undef ENTERED_ETPU_START_SEC_VAR_NO_INIT
    #else
        #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ETPU_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ETPU_START_SEC_VAR_INIT
    #undef ETPU_START_SEC_VAR_INIT
    #define ENTERED_ETPU_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ETPU_STOP_SEC_VAR_INIT
            #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ETPU_STOP_SEC_VAR_INIT
    #ifdef ENTERED_ETPU_START_SEC_VAR_INIT
        #undef ENTERED_ETPU_START_SEC_VAR_INIT
    #else
        #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef ETPU_START_SEC_VAR_SHARED_INIT
    #undef ETPU_START_SEC_VAR_SHARED_INIT
    #define ENTERED_ETPU_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ETPU_STOP_SEC_VAR_SHARED_INIT
            #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ETPU_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_ETPU_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_ETPU_START_SEC_VAR_SHARED_INIT
    #else
        #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ETPU_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ETPU_START_SEC_VAR_SHARED_NO_INIT
    #undef ETPU_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_ETPU_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef ETPU_STOP_SEC_VAR_SHARED_NO_INIT
            #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ETPU_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_ETPU_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_ETPU_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error ETPU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ETPU_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Etpu_MemMap.h, no valid memory mapping symbol defined."
#endif

...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define FEE_MEMMAP_SECTION_NOTMATCH_ERROR   "Fee_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef FEE_START_SEC_CONFIG_DATA
    #undef FEE_START_SEC_CONFIG_DATA
    #define ENTERED_FEE_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_CONFIG_DATA
...
#ifdef FEE_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_FEE_START_SEC_CONFIG_DATA
        #undef ENTERED_FEE_START_SEC_CONFIG_DATA
    #else
        #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef FEE_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef FEE_START_SEC_VAR_NO_INIT
    #undef FEE_START_SEC_VAR_NO_INIT
    #define ENTERED_FEE_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_NO_INIT
            #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FEE_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_FEE_START_SEC_VAR_NO_INIT
        #undef ENTERED_FEE_START_SEC_VAR_NO_INIT
    #else
        #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FEE_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef FEE_START_SEC_VAR_INIT
    #undef FEE_START_SEC_VAR_INIT
    #define ENTERED_FEE_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_INIT
            #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FEE_STOP_SEC_VAR_INIT
    #ifdef ENTERED_FEE_START_SEC_VAR_INIT
        #undef ENTERED_FEE_START_SEC_VAR_INIT
    #else
        #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef FEE_START_SEC_VAR_SHARED_INIT
    #undef FEE_START_SEC_VAR_SHARED_INIT
    #define ENTERED_FEE_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FEE_STOP_SEC_VAR_SHARED_INIT
            #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FEE_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_FEE_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_FEE_START_SEC_VAR_SHARED_INIT
    #else
        #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FEE_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef FEE_START_SEC_VAR_SHARED_NO_INIT
    #undef FEE_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_FEE_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef FEE_STOP_SEC_VAR_SHARED_NO_INIT
            #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FEE_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_FEE_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_FEE_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error FEE_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FEE_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Fee_MemMap.h, no valid memory mapping symbol defined."
#endif

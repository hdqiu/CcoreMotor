...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define PWM_MEMMAP_SECTION_NOTMATCH_ERROR   "Pwm_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_PWM_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef PWM_STOP_SEC_CONFIG_DATA
            #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_PWM_START_SEC_CONFIG_DATA
        #undef ENTERED_PWM_START_SEC_CONFIG_DATA
    #else
        #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef PWM_START_SEC_VAR_NO_INIT
    #undef PWM_START_SEC_VAR_NO_INIT
    #define ENTERED_PWM_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef PWM_STOP_SEC_VAR_NO_INIT
            #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef PWM_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_PWM_START_SEC_VAR_NO_INIT
        #undef ENTERED_PWM_START_SEC_VAR_NO_INIT
    #else
        #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef PWM_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef PWM_START_SEC_VAR_INIT
    #undef PWM_START_SEC_VAR_INIT
    #define ENTERED_PWM_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef PWM_STOP_SEC_VAR_INIT
            #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef PWM_STOP_SEC_VAR_INIT
    #ifdef ENTERED_PWM_START_SEC_VAR_INIT
        #undef ENTERED_PWM_START_SEC_VAR_INIT
    #else
        #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef PWM_START_SEC_VAR_SHARED_INIT
    #undef PWM_START_SEC_VAR_SHARED_INIT
    #define ENTERED_PWM_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef PWM_STOP_SEC_VAR_SHARED_INIT
            #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef PWM_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_PWM_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_PWM_START_SEC_VAR_SHARED_INIT
    #else
        #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef PWM_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef PWM_START_SEC_VAR_SHARED_NO_INIT
    #undef PWM_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_PWM_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef PWM_STOP_SEC_VAR_SHARED_NO_INIT
            #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef PWM_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_PWM_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_PWM_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error PWM_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef PWM_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Pwm_MemMap.h, no valid memory mapping symbol defined."
#endif

...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define DIO_MEMMAP_SECTION_NOTMATCH_ERROR   "Dio_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_DIO_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef DIO_STOP_SEC_CONFIG_DATA
            #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_DIO_START_SEC_CONFIG_DATA
        #undef ENTERED_DIO_START_SEC_CONFIG_DATA
    #else
        #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef DIO_START_SEC_VAR_NO_INIT
    #undef DIO_START_SEC_VAR_NO_INIT
    #define ENTERED_DIO_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef DIO_STOP_SEC_VAR_NO_INIT
            #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef DIO_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_DIO_START_SEC_VAR_NO_INIT
        #undef ENTERED_DIO_START_SEC_VAR_NO_INIT
    #else
        #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef DIO_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef DIO_START_SEC_VAR_INIT
    #undef DIO_START_SEC_VAR_INIT
    #define ENTERED_DIO_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef DIO_STOP_SEC_VAR_INIT
            #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef DIO_STOP_SEC_VAR_INIT
    #ifdef ENTERED_DIO_START_SEC_VAR_INIT
        #undef ENTERED_DIO_START_SEC_VAR_INIT
    #else
        #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef DIO_START_SEC_VAR_SHARED_INIT
    #undef DIO_START_SEC_VAR_SHARED_INIT
    #define ENTERED_DIO_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef DIO_STOP_SEC_VAR_SHARED_INIT
            #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef DIO_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_DIO_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_DIO_START_SEC_VAR_SHARED_INIT
    #else
        #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef DIO_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef DIO_START_SEC_VAR_SHARED_NO_INIT
    #undef DIO_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_DIO_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef DIO_STOP_SEC_VAR_SHARED_NO_INIT
            #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef DIO_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_DIO_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_DIO_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error DIO_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef DIO_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif

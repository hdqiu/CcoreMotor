...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define WDG_MEMMAP_SECTION_NOTMATCH_ERROR   "Wdg_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_WDG_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef WDG_STOP_SEC_CONFIG_DATA
            #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_WDG_START_SEC_CONFIG_DATA
        #undef ENTERED_WDG_START_SEC_CONFIG_DATA
    #else
        #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef WDG_START_SEC_VAR_NO_INIT
    #undef WDG_START_SEC_VAR_NO_INIT
    #define ENTERED_WDG_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef WDG_STOP_SEC_VAR_NO_INIT
            #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef WDG_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_WDG_START_SEC_VAR_NO_INIT
        #undef ENTERED_WDG_START_SEC_VAR_NO_INIT
    #else
        #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef WDG_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef WDG_START_SEC_VAR_INIT
    #undef WDG_START_SEC_VAR_INIT
    #define ENTERED_WDG_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef WDG_STOP_SEC_VAR_INIT
            #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef WDG_STOP_SEC_VAR_INIT
    #ifdef ENTERED_WDG_START_SEC_VAR_INIT
        #undef ENTERED_WDG_START_SEC_VAR_INIT
    #else
        #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef WDG_START_SEC_VAR_SHARED_INIT
    #undef WDG_START_SEC_VAR_SHARED_INIT
    #define ENTERED_WDG_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef WDG_STOP_SEC_VAR_SHARED_INIT
            #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef WDG_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_WDG_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_WDG_START_SEC_VAR_SHARED_INIT
    #else
        #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef WDG_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef WDG_START_SEC_VAR_SHARED_NO_INIT
    #undef WDG_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_WDG_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef WDG_STOP_SEC_VAR_SHARED_NO_INIT
            #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef WDG_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_WDG_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_WDG_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error WDG_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef WDG_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Wdg_MemMap.h, no valid memory mapping symbol defined."
#endif

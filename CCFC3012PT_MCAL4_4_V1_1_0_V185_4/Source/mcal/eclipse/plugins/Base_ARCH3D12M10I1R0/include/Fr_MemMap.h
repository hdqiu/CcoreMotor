...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define FR_MEMMAP_SECTION_NOTMATCH_ERROR   "Fr_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef FR_START_SEC_CONFIG_DATA
    #undef FR_START_SEC_CONFIG_DATA
    #define ENTERED_FR_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FR_STOP_SEC_CONFIG_DATA
            #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FR_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_FR_START_SEC_CONFIG_DATA
        #undef ENTERED_FR_START_SEC_CONFIG_DATA
    #else
        #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef FR_START_SEC_VAR_NO_INIT
    #undef FR_START_SEC_VAR_NO_INIT
    #define ENTERED_FR_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FR_STOP_SEC_VAR_NO_INIT
            #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FR_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_FR_START_SEC_VAR_NO_INIT
        #undef ENTERED_FR_START_SEC_VAR_NO_INIT
    #else
        #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef FR_START_SEC_VAR_INIT
    #undef FR_START_SEC_VAR_INIT
    #define ENTERED_FR_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FR_STOP_SEC_VAR_INIT
            #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FR_STOP_SEC_VAR_INIT
    #ifdef ENTERED_FR_START_SEC_VAR_INIT
        #undef ENTERED_FR_START_SEC_VAR_INIT
    #else
        #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef FR_START_SEC_VAR_SHARED_INIT
    #undef FR_START_SEC_VAR_SHARED_INIT
    #define ENTERED_FR_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef FR_STOP_SEC_VAR_SHARED_INIT
            #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FR_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_FR_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_FR_START_SEC_VAR_SHARED_INIT
    #else
        #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FR_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef FR_START_SEC_VAR_SHARED_NO_INIT
    #undef FR_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_FR_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef FR_STOP_SEC_VAR_SHARED_NO_INIT
            #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef FR_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_FR_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_FR_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error FR_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef FR_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Fr_MemMap.h, no valid memory mapping symbol defined."
#endif

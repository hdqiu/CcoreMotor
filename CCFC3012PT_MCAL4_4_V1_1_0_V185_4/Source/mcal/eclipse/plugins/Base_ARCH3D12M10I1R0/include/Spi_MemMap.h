...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define SPI_MEMMAP_SECTION_NOTMATCH_ERROR   "Spi_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_SPI_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SPI_STOP_SEC_CONFIG_DATA
            #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_SPI_START_SEC_CONFIG_DATA
        #undef ENTERED_SPI_START_SEC_CONFIG_DATA
    #else
        #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef SPI_START_SEC_VAR_NO_INIT
    #undef SPI_START_SEC_VAR_NO_INIT
    #define ENTERED_SPI_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SPI_STOP_SEC_VAR_NO_INIT
            #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SPI_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_SPI_START_SEC_VAR_NO_INIT
        #undef ENTERED_SPI_START_SEC_VAR_NO_INIT
    #else
        #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef SPI_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef SPI_START_SEC_VAR_INIT
    #undef SPI_START_SEC_VAR_INIT
    #define ENTERED_SPI_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SPI_STOP_SEC_VAR_INIT
            #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SPI_STOP_SEC_VAR_INIT
    #ifdef ENTERED_SPI_START_SEC_VAR_INIT
        #undef ENTERED_SPI_START_SEC_VAR_INIT
    #else
        #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef SPI_START_SEC_VAR_SHARED_INIT
    #undef SPI_START_SEC_VAR_SHARED_INIT
    #define ENTERED_SPI_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef SPI_STOP_SEC_VAR_SHARED_INIT
            #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SPI_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_SPI_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_SPI_START_SEC_VAR_SHARED_INIT
    #else
        #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef SPI_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef SPI_START_SEC_VAR_SHARED_NO_INIT
    #undef SPI_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_SPI_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef SPI_STOP_SEC_VAR_SHARED_NO_INIT
            #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef SPI_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_SPI_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_SPI_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error SPI_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef SPI_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Spi_MemMap.h, no valid memory mapping symbol defined."
#endif

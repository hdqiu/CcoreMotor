...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define GPT_MEMMAP_SECTION_NOTMATCH_ERROR   "Gpt_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_GPT_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef GPT_STOP_SEC_CONFIG_DATA
            #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_GPT_START_SEC_CONFIG_DATA
        #undef ENTERED_GPT_START_SEC_CONFIG_DATA
    #else
        #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef GPT_START_SEC_VAR_NO_INIT
    #undef GPT_START_SEC_VAR_NO_INIT
    #define ENTERED_GPT_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef GPT_STOP_SEC_VAR_NO_INIT
            #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef GPT_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_GPT_START_SEC_VAR_NO_INIT
        #undef ENTERED_GPT_START_SEC_VAR_NO_INIT
    #else
        #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef GPT_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef GPT_START_SEC_VAR_INIT
    #undef GPT_START_SEC_VAR_INIT
    #define ENTERED_GPT_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef GPT_STOP_SEC_VAR_INIT
            #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef GPT_STOP_SEC_VAR_INIT
    #ifdef ENTERED_GPT_START_SEC_VAR_INIT
        #undef ENTERED_GPT_START_SEC_VAR_INIT
    #else
        #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef GPT_START_SEC_VAR_SHARED_INIT
    #undef GPT_START_SEC_VAR_SHARED_INIT
    #define ENTERED_GPT_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef GPT_STOP_SEC_VAR_SHARED_INIT
            #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef GPT_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_GPT_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_GPT_START_SEC_VAR_SHARED_INIT
    #else
        #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef GPT_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef GPT_START_SEC_VAR_SHARED_NO_INIT
    #undef GPT_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_GPT_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef GPT_STOP_SEC_VAR_SHARED_NO_INIT
            #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef GPT_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_GPT_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_GPT_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error GPT_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef GPT_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif

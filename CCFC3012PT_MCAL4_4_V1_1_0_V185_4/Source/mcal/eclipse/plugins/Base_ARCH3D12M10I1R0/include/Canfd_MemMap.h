...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define CANFD_MEMMAP_SECTION_NOTMATCH_ERROR   "Canfd_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
#ifdef CANFD_START_SEC_CONFIG_DATA
    #undef CANFD_START_SEC_CONFIG_DATA
    #define ENTERED_CANFD_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CANFD_STOP_SEC_CONFIG_DATA
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_CONFIG_DATA
    #ifdef ENTERED_CANFD_START_SEC_CONFIG_DATA
        #undef ENTERED_CANFD_START_SEC_CONFIG_DATA
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    ...
    #endif
    #undef CANFD_STOP_SEC_CONFIG_DATA
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CANFD_START_SEC_CODE
    #undef CANFD_START_SEC_CODE
    #define ENTERED_CANFD_START_SEC_CODE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CANFD_STOP_SEC_CODE
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_CODE
    #ifdef ENTERED_CANFD_START_SEC_CODE
        #undef ENTERED_CANFD_START_SEC_CODE
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef CANFD_START_SEC_VAR_NO_INIT
    #undef CANFD_START_SEC_VAR_NO_INIT
    #define ENTERED_CANFD_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CANFD_STOP_SEC_VAR_NO_INIT
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_CANFD_START_SEC_VAR_NO_INIT
        #undef ENTERED_CANFD_START_SEC_VAR_NO_INIT
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CANFD_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CANFD_START_SEC_VAR_INIT
    #undef CANFD_START_SEC_VAR_INIT
    #define ENTERED_CANFD_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CANFD_STOP_SEC_VAR_INIT
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_VAR_INIT
    #ifdef ENTERED_CANFD_START_SEC_VAR_INIT
        #undef ENTERED_CANFD_START_SEC_VAR_INIT
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef CANFD_START_SEC_VAR_SHARED_INIT
    #undef CANFD_START_SEC_VAR_SHARED_INIT
    #define ENTERED_CANFD_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef CANFD_STOP_SEC_VAR_SHARED_INIT
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_CANFD_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_CANFD_START_SEC_VAR_SHARED_INIT
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CANFD_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CANFD_START_SEC_VAR_SHARED_NO_INIT
    #undef CANFD_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_CANFD_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef CANFD_STOP_SEC_VAR_SHARED_NO_INIT
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_CANFD_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_CANFD_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef CANFD_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef CANFD_START_SEC_RAMCODE
    #undef CANFD_START_SEC_RAMCODE
    #define ENTERED_CANFD_START_SEC_RAMCODE
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef CANFD_STOP_SEC_RAMCODE
            #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef CANFD_STOP_SEC_RAMCODE
    #ifdef ENTERED_CANFD_START_SEC_RAMCODE
        #undef ENTERED_CANFD_START_SEC_RAMCODE
    #else
        #error CANFD_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
#ifdef MEM_ERROR
    #error "Canfd_MemMap.h, no valid memory mapping symbol defined."
#endif

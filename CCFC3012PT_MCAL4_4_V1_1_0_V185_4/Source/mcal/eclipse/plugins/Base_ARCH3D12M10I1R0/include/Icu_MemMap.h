...
/*====================================================================================================
                                             LOCAL MACROS
====================================================================================================*/
#define ICU_MEMMAP_SECTION_NOTMATCH_ERROR   "Icu_MemMap.h, start - stop section defined not match."
#define MEM_ERROR
...
*/
    ...
    #define ENTERED_ICU_START_SEC_CONFIG_DATA
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ICU_STOP_SEC_CONFIG_DATA
            #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
    ...
    #ifdef ENTERED_ICU_START_SEC_CONFIG_DATA
        #undef ENTERED_ICU_START_SEC_CONFIG_DATA
    #else
        #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
...
*/
#ifdef ICU_START_SEC_VAR_NO_INIT
    #undef ICU_START_SEC_VAR_NO_INIT
    #define ENTERED_ICU_START_SEC_VAR_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ICU_STOP_SEC_VAR_NO_INIT
            #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ICU_STOP_SEC_VAR_NO_INIT
    #ifdef ENTERED_ICU_START_SEC_VAR_NO_INIT
        #undef ENTERED_ICU_START_SEC_VAR_NO_INIT
    #else
        #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ICU_STOP_SEC_VAR_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ICU_START_SEC_VAR_INIT
    #undef ICU_START_SEC_VAR_INIT
    #define ENTERED_ICU_START_SEC_VAR_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ICU_STOP_SEC_VAR_INIT
            #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ICU_STOP_SEC_VAR_INIT
    #ifdef ENTERED_ICU_START_SEC_VAR_INIT
        #undef ENTERED_ICU_START_SEC_VAR_INIT
    #else
        #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
...
*/
#ifdef ICU_START_SEC_VAR_SHARED_INIT
    #undef ICU_START_SEC_VAR_SHARED_INIT
    #define ENTERED_ICU_START_SEC_VAR_SHARED_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifndef ICU_STOP_SEC_VAR_SHARED_INIT
            #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ICU_STOP_SEC_VAR_SHARED_INIT
    #ifdef ENTERED_ICU_START_SEC_VAR_SHARED_INIT
        #undef ENTERED_ICU_START_SEC_VAR_SHARED_INIT
    #else
        #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ICU_STOP_SEC_VAR_SHARED_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
*/
#ifdef ICU_START_SEC_VAR_SHARED_NO_INIT
    #undef ICU_START_SEC_VAR_SHARED_NO_INIT
    #define ENTERED_ICU_START_SEC_VAR_SHARED_NO_INIT
    #ifndef MEMMAP_MATCH_ERROR
        #define MEMMAP_MATCH_ERROR
    #else
        #ifdef ICU_STOP_SEC_VAR_SHARED_NO_INIT
            #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
        #endif
    #endif
    #undef MEM_ERROR
...
#ifdef ICU_STOP_SEC_VAR_SHARED_NO_INIT
    #ifdef ENTERED_ICU_START_SEC_VAR_SHARED_NO_INIT
        #undef ENTERED_ICU_START_SEC_VAR_SHARED_NO_INIT
    #else
        #error ICU_MEMMAP_SECTION_NOTMATCH_ERROR
    #endif
    #ifdef MEMMAP_MATCH_ERROR
        #undef MEMMAP_MATCH_ERROR
    #endif
    #undef ICU_STOP_SEC_VAR_SHARED_NO_INIT
    #undef MEM_ERROR
        /* no definition -> default compiler settings are used */
#endif
...
#ifdef MEM_ERROR
    #error "Icu_MemMap.h, no valid memory mapping symbol defined."
#endif

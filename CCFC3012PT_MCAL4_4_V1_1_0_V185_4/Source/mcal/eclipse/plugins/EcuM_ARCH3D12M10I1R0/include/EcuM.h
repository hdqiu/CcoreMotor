...
#if ((ECUM_AR_RELEASE_MAJOR_VERSION != ECUM_CBK_AR_RELEASE_MAJOR_VER) || \
     (ECUM_AR_RELEASE_MINOR_VERSION != ECUM_CBK_AR_RELEASE_MINOR_VER) || \
     (ECUM_AR_RELEASE_REVISION != ECUM_CBK_AR_RELEASE_REVISION))
#error "AutoSar Version Numbers of EcuM_Cbk.h and EcuM.h are different"
     ...
     (ECUM_AR_RELEASE_REVISION != ECUM_CFG_AR_RELEASE_REVISION_VERSION))

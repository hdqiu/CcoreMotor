...
{
[!IF "node:exists(WdgDemEventParameterRefs/WdgDemEventParameterRefs/WDG_E_DISABLE_REJECTED/__1)"!][!//
    (uint32)STD_ON,
[!ELSE!]
    (uint32)STD_OFF,
[!ENDIF!]
...
{
[!IF "node:exists(WdgDemEventParameterRefs/WdgDemEventParameterRefs/WDG_E_MODE_FAILED/__1)"!]
    (uint32)STD_ON,
[!ELSE!]
    (uint32)STD_OFF,
[!ENDIF!]

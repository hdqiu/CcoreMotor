...
#define CAN_176_CANFD_PRECOMPILE_SUPPORT[!WS "4"!][!//
...
#define CAN_176_CANFD_MULTICORE_ENABLED[!WS "4"!][!IF "(CanGeneral/CanMulticoreSupport = 'true')"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
...
[!LOOP "CanConfigSet/CanController/*"!]
    ...
    [!ENDIF!]
[!ENDLOOP!]
#define CAN_176_CANFD_CHECK_WAKEUP_API [!WS "4"!][!IF "($check_wakeup_en = num:i(1))"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]

#define CAN_176_CANFD_FD_MODE_ENABLE [!WS "4"!][!//
...
[!SELECT "CanGeneral"!][!//
#define CAN_176_CANFD_DEV_ERROR_DETECT[!WS "4"!][!//
...
#define CAN_176_CANFD_VERSION_INFO_API[!WS "4"!][!//
...
#define CAN_176_CANFD_INSTANCE[!WS "4"!]([!"num:i(CanIndex)"!]U)

[!IF "node:exists(CanMainFunctionBusoffPeriod)"!][!//
#define CAN_176_CANFD_MAINFUNCTION_BUSOFF_PERIOD[!WS "4"!]([!"num:i(CanMainFunctionBusoffPeriod)"!]U)
[!ENDIF!][!//

[!IF "node:exists(CanMainFunctionModePeriod)"!][!//
#define CAN_176_CANFD_MAINFUNCTION_MODE_PERIOD[!WS "4"!]([!"num:i(CanMainFunctionModePeriod)"!]U)
[!ENDIF!][!//

[!IF "node:exists(CanMainFunctionWakeupPeriod)"!][!//
#define CAN_176_CANFD_MAINFUNCTION_WAKEUP_PERIOD[!WS "4"!]([!"num:i(CanMainFunctionWakeupPeriod)"!]U)
[!ENDIF!][!//

#define CAN_176_CANFD_MULTIPLEXED_TRANSMISSION[!WS "4"!][!//
...
#define CAN_176_CANFD_SET_BAUDRATE_API [!WS "4"!][!IF "(CanSetBaudrateApi = 'true')"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
...
[!ENDLOOP!]
[!ENDNOCODE!]
#define CAN_176_CANFD_MAINFUNCTION_BUSOFF_API [!WS "4"!][!IF "$busoff_pol_en = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
#define CAN_176_CANFD_MAINFUNCTION_WAKEUP_API [!WS "4"!][!IF "$wakeup_pol_en = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
#define CAN_176_CANFD_WAKEUP_SUPPORT [!WS "4"!][!IF "$wakeup_en = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
/* The unit is us. */
[!IF "node:exists(CanOsCounterRef)"!]
#define CAN_176_CANFD_TIMEOUT_DURATION [!WS "4"!][!"num:i(CanTimeoutDuration * 1000000)"!]U[!CR!]
[!ELSE!]
    [!SELECT "node:ref(CanOsCounterRef)"!]
#define CAN_176_CANFD_TIMEOUT_COUNTER_NAME   [!"@name"!]
#define CAN_176_CANFD_TIMEOUT_USE_OS [!WS "4"!](STD_ON)
#define CAN_176_CANFD_TIMEOUT_COUNTER_TICK2NS()   OS_TICKS2NS_[!"@name"!](1U)
    [!ENDSELECT!]
/* The unit is ns. */
#define CAN_176_CANFD_TIMEOUT_DURATION [!WS "4"!][!"CanTimeoutDuration * 1000000000"!]F[!CR!]
[!ENDIF!]

[!IF "num:i(count(CanMainFunctionRWPeriods/*)) = 1"!][!//
#define CAN_176_CANFD_MAINFUNCTION_PERIOD         ([!"CanMainFunctionRWPeriods/*[1]/CanMainFunctionPeriod"!]F)
#define CAN_176_CANFD_MAINFUNCTION_PERIOD_READ    ([!"CanMainFunctionRWPeriods/*[1]/CanMainFunctionPeriod"!]F)
#define CAN_176_CANFD_MULTIPLE_READ_PERIOD        (STD_OFF)
#define CAN_176_CANFD_MAINFUNCTION_PERIOD_WRITE   ([!"CanMainFunctionRWPeriods/*[1]/CanMainFunctionPeriod"!]F)  
#define CAN_176_CANFD_MULTIPLE_WRITE_PERIOD       (STD_OFF)
[!ELSE!][!//
...
#define CAN_176_CANFD_MAINFUNCTION_RW_PERIOD_[!"@index"!]            ([!"CanMainFunctionPeriod"!]F)
#define CAN_176_CANFD_MAINFUNCTION_PERIOD_READ_[!"@index"!]       ([!"CanMainFunctionPeriod"!]F)
#define CAN_176_CANFD_MAINFUNCTION_PERIOD_WRITE_[!"@index"!]      ([!"CanMainFunctionPeriod"!]F)
[!ENDLOOP!][!//
[!ENDIF!][!//
[!//
...
[!ENDNOCODE!][!//
[!SELECT "CanConfigSet"!][!//
#define CAN_176_CANFD_CONTROLLER_COUNT    [!"num:i(count(CanController/*))"!]U
[!NOCODE!][!//
...
[!ENDLOOP!]
[!ENDNOCODE!][!//
#define CAN_176_CANFD_MAINFUNCTION_WRITE_API [!WS "4"!][!IF "$tx_pol_en = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
#define CAN_176_CANFD_MAINFUNCTION_READ_API [!WS "4"!][!IF "$rx_pol_en = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
#define CAN_176_CANFD_TRIGGER_TRANSMIT_EN [!WS "4"!][!IF "$CanTriggerTransmitEnable_en = 1"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!][!CR!]
...
[!ENDLOOP!]
#define CAN_176_CANFD_MB_COUNT       [!"num:i($HardwareObjectCnt1)"!]U
#define CAN_176_CANFD_HOH_CNT_MAX    [!"num:i($HardwareObjectCnt0)"!]U
#define CAN_176_CANFD_DEFAULT_COREID [!"num:i(ecu:get('MCAL.DEFAULT.COREID'))"!]U
[!ENDSELECT!]
...
#define Can_176_CanFd_LPduReceiveCalloutFunction     ([!"normalize-space(CanLPduReceiveCalloutFunction)"!])
        [!ENDIF!]
    [!ENDIF!]
[!ENDSELECT!]

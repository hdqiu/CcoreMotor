...
SWLIBS_INLINE tFloat Mac_FLT_C(register tFloat fltIn1,register tFloat fltIn2,register tFloat fltIn3)
{
  ...
  SWLIBS_INLINE tFloat Mac_FLT_ASM_EFPU2(register tFloat fltIn1,register tFloat fltIn2,register tFloat fltIn3)
  {
    ...
    fltReturn = fltIn1;
      ...
      #pragma ghs optasm
    #endif
    SWLIBS_ASM(" efsmadd %0,%1,%2": "+r"(fltReturn): "r"(fltIn2), "r"(fltIn3));
    return((tFloat)fltReturn);     
  }  
#endif /* MLIB_EFPU2_ASM */
#ifdef __DCC__
/* Target-specific implementation */
SWLIBS_INLINE tFloat Mac_FLT_DIAB_EFPU2(register tFloat fltIn1,register tFloat fltIn2,register tFloat fltIn3)
{
    register tFloat fltReturn;
    fltReturn = fltIn1;
    fltReturn = __efs_madd(fltIn2, fltIn3, fltReturn);
    return((tFloat)fltReturn); 
}
...
SWLIBS_INLINE tFloat MLIB_Mac_FLT(register tFloat fltIn1,register tFloat fltIn2,register tFloat fltIn3)
{
  #ifdef __ghs__
    /* @remarks Implements DMLIB00213 */
    return(Mac_FLT_ASM_EFPU2(fltIn1,fltIn2,fltIn3));
